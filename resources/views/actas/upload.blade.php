                ...
                <form method="POST" action="{{route('upload')}}" accept-charset="UTF-8" enctype="multipart/form-data">
                  ...
                  <div class="form-row m-3 p-3">
                    <div class="col">
                      ...
                      <input class="form-control" type="text" name="categoria" id="categoria" value="Actas" readonly>
                    </div>

                    <div class="col">
                      <label for="academia">Academia</label>
                      <input class="form-control" type="text" name="academia" id="academia" value="{{$idacademia}}"
                             readonly>
                    </div>

                    <div class="col">
                      <label for="materia">Materia</label>
                      <input class="form-control" type="text" name="materia" id="materia" value="{{$idmateria}}"
                             readonly>
                    </div>
